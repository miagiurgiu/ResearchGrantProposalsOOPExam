...
* To be able to select a row from a `QTableView`: use function `setSelectionBehavior(QAbstractItemView::SelectRows)` and make sure to set the `Qt::ItemIsSelectable` flag in the associated model;
